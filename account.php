...
<?php foreach ($Members as $member) { ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-blackness">
                <div class="modal-body text-dark">
                    ...
                    <form action="actionEdit.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                        <input type="hidden" name="ID_Member" value="<?= $member['ID_Member'] ?>">
                        <div class="mb-3">
                            <label for="Nama_member" class="form-label">Nama Member</label>
                            <input type="text" class="form-control" id="Nama_member" name="Nama_member" value="<?= htmlspecialchars($member['Nama_member']) ?>" pattern="[a-zA-Z\s]+" title="Hanya huruf dan spasi yang diizinkan" required>
                        </div>
                        <div class="mb-3">
                            <label for="Alamat" class="form-label">Alamat</label>
                            <input type="text" class="form-control" id="Alamat" name="Alamat" value="<?= htmlspecialchars($member['Alamat']) ?>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="Password_member" name="Password_member" value="<?= htmlspecialchars($member['Password_Member']) ?>" required>
                        </div>
                        <div class="mb-3">
    ...
    <script>
        function validateForm() {
            ...
            var noTelp = document.getElementById("Nomor_Telepon").value;
            var password = document.getElementById("Password_member").value;

            if (nama === "" || alamat === "" || email === "" || noTelp === "" || password === "") {
