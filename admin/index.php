...
<?php
    $query_total_orders = "SELECT COUNT(*) AS total_orders FROM sewa";
    ...
    $query_total_payments = "SELECT SUM(Total_harga) AS total_payments FROM transaksi";
    ...
    $query_total_paid = "SELECT COUNT(*) AS total_paid FROM transaksi WHERE Status_Pembayaran = 'LUNAS'";
