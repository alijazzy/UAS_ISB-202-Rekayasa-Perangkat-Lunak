...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; 2024 | Sistem Informasi Itenas Bandung | This website is made with <i class="fas fa-heart" aria-hidden="true" style="color: red;"></i> by <a href="https://github.com/kurniaramadhan" target="_blank">Kelompok 2</a></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
